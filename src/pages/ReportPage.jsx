...
const ReportPage = () => {
  ...
  return (
    <div className="px-10 py-16">
      <div className="upper-text pt-6 pb-4 px-0 sm:px-24 text-[#0F172A]">
      ...
      <div className="pt-20">
        <h1 className="text-xl min-[400px]:text-3xl md:text-4xl text-[#164E63] pt-4 pb-6 font-[serif]">
          Quiz Reports
        </h1>
                ...
                {isLoading ? (
                  ...
                  >
                    ...
                    <div className="flex flex-col px-2 gap-4">
                      ...
                      <h1 className={`text-lg text-center mt-4 text-[#fff] uppercase`}>
                        {report.result}
                      </h1>
                    </div>
                  </div>
